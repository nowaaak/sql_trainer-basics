const exercises = [
    ...
    },
    {
        ...
        validation: {
            ...
            optionalKeywords: ['Bezeichnung', 'Preis', 'Lagerbestand', '49.99', '19.99', '179.99', '25', '60', '10'],
            hints: [
    ...
    },
    {
        ...
        validation: {
            ...
            optionalKeywords: ['Preis', '*', '1.1', '+', '0.1'],
            hints: [
    ...
    },
    {
        ...
        description: `
            ...
            <p>Auch Bestellungen von gelöschten Kunden (KundenID existiert, aber Kunde wurde gelöscht) sollen erscheinen!</p>
        `,
        schema: {
            tables: [
                {
    ...
    },
    {
        ...
        description: `
            ...
            <p>Verwende Aliase (<code>m</code> für Mitarbeiter, <code>a</code> für Abteilungen) um die Abfrage kürzer zu schreiben.</p>
    ...
    },
    {
        ...
        description: `
            ...
            <p>Die Tabelle Mitarbeiter enthält eine Spalte <code>VorgesetzterID</code>, die auf einen anderen Mitarbeiter verweist.</p>
    ...
    },
    {
        ...
        category: 'joins',
        joinType: 'left',
        title: 'LEFT JOIN - Kunden mit letzter Bestellung',
        difficulty: 3,
        description: `
